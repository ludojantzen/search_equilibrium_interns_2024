...
#%% Input parameters
# Files
case_name = 'gFHR_U235_18' # Name for folder to create
main_input_file = 'input' # Name of the main Serpent input file (must be in same folder as script)
...
fracs = [0.5,0.5] # fraction of pebbles in the pebble bed for each pebble type (might want to convert it to dictionary)
is_fuel = [True,True] # type of pebble (burnable or not) in the pebble bed for each pebble type (might want to convert it to dictionary)
vol_per_pebble = [0.362644,0.362644]#, 0.362644,None] # volume of material in the pebble bed for each pebble type (might want to convert it to dictionary)
...
# Simulation
sss_exe = "/global/home/groups/co_nuclear/HxF_tools/serpent2.2.0_HxF_dev/sss2" # path to Serpent executable (HxF_tools version)
